...
export class ApiService {
  ...
  public BASE_URL_BRAZIL = "https://sigageomarketing.com.br/coronavirus/coronavirus.js";
  public BASE_URL_WORLD = ""
  ...
  getBrazil() {
    return new Promise(resolve => {
      this.http.get(this.BASE_URL_BRAZIL)
        .subscribe(
          (data: any) => {
  ...
  getWorld() {
    return new Promise(resolve => {
      this.http.get(this.BASE_URL_WORLD + "/api/data/world")
        .subscribe(
          (data: any) => {
